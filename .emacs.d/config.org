...
#+begin_src emacs-lisp
  ...
  (setq org-publish-project-alist
        '(
          ("org-pages" :base-directory "~/Dropbox/org/roam/daily" :base-extension "org" :publishing-directory "/ssh:root@lantana.io:/var/www/html/org/daily" :recursive t :publishing-function org-html-publish-to-html :headline-levels 4 :auto-preamble t :exclude "daily/work/\\|iFIT\\|lantana.index.org" :auto-sitemap t :sitemap-filename "index.org" :sitemap-title "Hello" :sitemap-sort-files anti-chronologically)
...
#+begin_src emacs-lisp
  (use-package org-ai
    ...
    (setq org-ai-image-directory (expand-file-name "org-ai-images/" org-directory))) ; if you are using yasnippet and want `ai` snippets
  ...
  (setq gptel-tools (list
                     ...
                     (gptel-make-tool
                      ...
                      :function (lambda (url)
                                  (with-temp-buffer
                                    ...
                                    (buffer-string)))
                      :description "Fetch and return the contents of the specified URL"
                      :args (list '(:name "url"
                                          :type string
                     ...
                     (gptel-make-tool
                      ...
                      :function (lambda ()
                                  ...
                                  (message "got the major mode"))
                      :description "Return the major mode of the current buffer to give coding language information."
                      :args nil
                      :category "buffer")))

...
#+begin_src emacs-lisp
  ...
  (setq org-publish-project-alist
        '(
          ("org-pages" :base-directory "~/Dropbox/org/roam/" :base-extension "org" :publishing-directory "/ssh:root@pi.hole:/var/www/html/org/" :recursive t :publishing-function org-html-publish-to-html :headline-levels 4 :auto-preamble t :exclude "daily/work/\\|iFIT\\|lantana.index.org" :auto-sitemap t :sitemap-filename "index.org" :sitemap-title "Hello" :sitemap-sort-files anti-chronologically)
          ("org-attachments" :base-directory "~/Dropbox/org/roam/data/" :base-extension any :publishing-directory "/ssh:root@pi.hole:/var/www/html/org/data/" :recursive t :publishing-function org-publish-attachment)
          ("org-daily-attachments" :base-directory "~/Dropbox/org/roam/daily/data/" :base-extension any :publishing-directory "/ssh:root@pi.hole:/var/www/html/org/daily/data" :recursive t :publishing-function org-publish-attachment)
          ("org-app" :base-directory "~/Dropbox/org/roam/js/" :base-extension any :publishing-directory "/ssh:root@pi.hole:/var/www/html/org/js/" :recursive t :publishing-function org-publish-attachment)
          ("lantana-index" :base-directory "~/Dropbox/org/" :base-extension "org" :publishing-directory "/ssh:root@pi.hole:/var/www/html/" :publishing-function org-html-publish-to-html)
          ("LANtana" :components
...
#+begin_src emacs-lisp
  (use-package gptel
    ...
    (defun gim/get-gptel-api-key ()
      ...
      (let ((auth (nth 0 (auth-source-search :machine "api.perplexity.ai" :user "apikey" :max 1 :require '(:secret)))))
        (if auth
            (funcall (plist-get auth :secret))
          (error "No GPTel API key found in authinfo file"))))
    (setq gptel-model   'llama-3.1-sonar-huge-128k-online
          gptel-backend
